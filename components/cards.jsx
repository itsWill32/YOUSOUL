    ...
    <>
      <div className="main-cards">
        <div className="card-container">
          <Image src={anillo} className="card-img" width={200} height={180} />
          <h2>Anillo oro amarillo 6mm</h2>
          <span className="price-joyas">$500</span>
          <div className="card-container-span">
            <Link href="./addToCart" className="card-shop-add">
        ...
        <div className="card-container">
          <Image src={anillo2} className="card-img" width={200} height={180} />
          <h2>Anillo oro amarillo 6mm</h2>
          <span className="price-joyas">$500</span>
          <div className="card-container-span">
            <Link href="./addToCart" className="card-shop-add">
        ...
        <div className="card-container">
          <Image src={anillo4} className="card-img" width={200} height={180} />
          <h2>Anillo oro amarillo 6mm</h2>
          <span className="price-joyas">$500</span>
          <div className="card-container-span">
            <Link href="./addToCart" className="card-shop-add">
      ...
      <div className="main-cards-2">
        <div className="card-container">
          <Image src={anillo5} className="card-img" width={200} height={180} />
          <h2>Anillo oro amarillo 6mm</h2>
          <span className="price-joyas">$500</span>
          <div className="card-container-span">
            <Link href="./addToCart" className="card-shop-add">
        ...
        <div className="card-container">
          <Image src={collar1} className="card-img" width={200} height={180} />
          <h2>Anillo oro amarillo 6mm</h2>
          <span className="price-joyas">$500</span>
          <div className="card-container-span">
            <Link href="./addToCart" className="card-shop-add">
        ...
        <div className="card-container">
          <Image src={collar2} className="card-img" width={200} height={180} />
          <h2>Anillo oro amarillo 6mm</h2>
          <span className="price-joyas">$500</span>
          <div className="card-container-span">
            <Link href="./addToCart" className="card-shop-add">
        ...
        <div className="card-container">
          <Image src={collar3} className="card-img" width={200} height={180} />
          <h2>Anillo oro amarillo 6mm</h2>
          <span className="price-joyas">$500</span>
          <div className="card-container-span">
            <Link href="./addToCart" className="card-shop-add">
